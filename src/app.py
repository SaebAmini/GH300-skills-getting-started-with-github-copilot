...
activities = {
    ...
    "Swimming Club": {
        "description": "Technique work and endurance training with certified coaches",
        "schedule": "Tuesdays and Thursdays, 5:00 PM - 6:30 PM",
        "max_participants": 20,
        "participants": ["noah@mergington.edu", "mia@mergington.edu"]
    },
    "Visual Arts Club": {
        "description": "Sketching, painting, and sculpture sessions guided by local artists",
    ...
    "Science Olympiad": {
        "description": "Prepare for regional science competitions through labs and problem solving",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["ethan@mergington.edu", "harper@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build public speaking and argumentation skills with weekly debates",
